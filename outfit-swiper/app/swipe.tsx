...
export default function SwipeScreen() {
  ...
  useEffect(() => {
    ...
    if (currentMacroIndex < macroOrder.length) {
      ...
      // Optimization: Use Set for O(1) lookup instead of O(N) array.includes to prevent UI stutter
      ...
      const itemsForPart = clothes.filter(c =>
        c.part === currentPart && (collectionItemIdsSet === null || collectionItemIdsSet.has(c.id))
      );
