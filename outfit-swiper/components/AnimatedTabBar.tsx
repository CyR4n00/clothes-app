...
const TABS = [
  { route: '/', icon: 'shirt-outline', activeColor: '#E0E0E0', accessibilityLabel: 'クローゼット' },
  { route: '/swipe', icon: 'layers-outline', activeColor: '#E0E0E0', accessibilityLabel: 'スワイプ' },
  { route: '/explore', icon: 'earth-outline', activeColor: '#E0E0E0', accessibilityLabel: '探索' },
];
