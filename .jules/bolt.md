...
## 2026-06-20 - Limit rendered views in Animated.View swiper dataset
**Learning:** Returning all items in a large dataset inside an Animated.View swiper hierarchy leads to severe memory and layout overhead.
**Action:** Return null early for views outside the immediate visible window (e.g. current + 2), significantly improving Swiper performance.
