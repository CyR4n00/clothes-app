...
## 2024-03-24 - Limit rendered view hierarchy in custom swiper components
...
**Action:** Limit rendering to only the top visible cards (e.g., returning `null` when `index > cardIndex + 2`) to improve performance.
