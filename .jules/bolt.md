...
## 2026-06-21 - Optimize Animated View Swiper Memory Usage
...
**Action:** Limit rendering to only the top visible cards (e.g., returning `null` when `index > cardIndex + 2`) instead of rendering all upcoming cards simultaneously.
